...
function imprimir()
{
	window.open ("reportes/reporte_salidas2.php?desde=" + document.form1.desde.value + "&hasta=" + document.form1.hasta.value + "&almacen=" + document.form1.almacen.value ,"Help","scrollBars=yes,resizable=no,toolbar=no,menubar=yes,top =10,left=10,location=no,directories=no,width=10,height=10"); 
