...
<tr>
	<td>
		<table width="100%" cellpadding="1" cellspacing="1" bgcolor="#FFFFFF">
			<tr bgcolor="#DDDDDD">
				<td width="40%" class="css-label-metadata" height="25">&nbsp;&nbsp;Username:</td>
				<td width="60%"><input name="username" type="text" class="css-campo-metadata" maxlength="5" onKeyPress="onNumero()">
			</tr>
			<tr bgcolor="#DDDDDD">
