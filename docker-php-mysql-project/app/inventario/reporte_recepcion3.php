...
while ($rs=mysql_fetch_array($result)){
	...
	$htm=$htm."<table width='100%' border='1' cellspacing='0' align='center' cellpadding='0'>";
	$htm=$htm."<tr>";
	$htm=$htm."	<td bgcolor='#F1F1F1'  colspan='11' align='center'>Detalle de Recepcion</td>";
	$htm=$htm."</tr>";

	$htm=$htm."<tr>";
	$htm=$htm."	<td width='5%' bgcolor='#F1F1F1'  align='center'>Id</td>";
	$htm=$htm."	<td width='10%' bgcolor='#F1F1F1' class='TITULO' align='left'>Producto</td>";
	$htm=$htm."	<td width='5%' bgcolor='#F1F1F1' class='TITULO' align='center'>Unidades</td>";
