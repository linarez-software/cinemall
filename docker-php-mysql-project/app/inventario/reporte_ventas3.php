...
<form method="post" name="form1" action="" >
			...
			echo"<td  valign='middle' bgcolor='#F1F1F1' class='titulo' align='center' colspan='3'><b>Ventas</b></td>";
			echo"</tr>";
			echo"<tr  valign='middle' height=30>";
			echo"<td  valign='middle' bgcolor='#F1F1F1' class='titulo' align='center' colspan='4'><b>Ventas por productos<br>Desde:&nbsp;".$fec[2]."/".$fec[1]."/".$fec[0]."&nbsp;&nbsp;&nbsp;Hasta:&nbsp;".$fec2[2]."/".$fec2[1]."/".$fec2[0]." </b></td>";
			echo"</tr>";
			echo"<tr  valign='middle' height=30>";
			echo"<td  valign='middle' bgcolor='#F1F1F1' class='titulo' align='center' colspan='3'><b>Almacen: $dep</b></td>";
			echo"</tr>";
			...
			while ($fila=mysql_fetch_array($result)){
					  ...
					  echo"	<td valign='middle' align='center'>".str_replace("*",".",str_replace(".",",",str_replace(",","*",number_format($fila[2],2))))."</td>";
			...
			echo"<tr  valign='middle'>";
			echo"<td bgcolor='#F1F1F1' class='titulo' align='right'><b>Total:</b></td>";
			echo"<td bgcolor='#F1F1F1' class='titulo' align='center'><b>".str_replace("*",".",str_replace(".",",",str_replace(",","*",number_format($t2,2))))."</b></td>";
