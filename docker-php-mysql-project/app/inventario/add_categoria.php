...
function Validar()
{
 ...
 document.form1.action="add_categoria.php?insert=0" ;
...
if ($_GET["insert"]==0)
{
	$sql="insert into pv_tbc_categoria values(NULL,'".strtoupper($_POST[producto])."','ACTIVO')";
