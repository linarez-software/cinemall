...
if($status > 0){ 
	...
	$Query1 = "SELECT * FROM tbl_usuario WHERE username = '$username' AND passwd = '$passwd' AND ((nivel >0 AND nivel <= 3)or(nivel =6)or(nivel =7))  AND activo = 1"; 
	...
	{ 
		...
		if($campo->nivel==7)header("location: productos.php"); 
