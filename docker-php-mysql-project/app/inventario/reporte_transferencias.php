...
<form method="post" name="form1" action="" >
			...
			echo"<td  valign='middle' bgcolor='#F1F1F1' class='titulo' align='center' colspan='6'><b>Transferencias</b></td>";
			echo"</tr>";
			echo"<tr  valign='middle' height=30>";
			echo"<td  valign='middle' bgcolor='#F1F1F1' class='titulo' align='center' colspan='6'><b>Transferencias por productos<br>Desde:&nbsp;".$fec[2]."/".$fec[1]."/".$fec[0]."&nbsp;&nbsp;&nbsp;Hasta:&nbsp;".$fec2[2]."/".$fec2[1]."/".$fec2[0]." </b></td>";
			echo"</tr>";
			echo"<tr  valign='middle' height=30>";
			...
			echo"</tr>";
				...
				$sql = " SELECT
					...
					order by pv_tbc_productos.CODIGO_PRODUCTO
					...
					"		;	
						...
						echo"<td bgcolor='#F1F1F1' class='titulo' align='center'><b>Origen</b></td>";
						...
						while ($fila=mysql_fetch_array($result)){
								  ...
								  if(($x==$fila[0].$fila[1])||($x=="")){
										  echo"<tr>";
										  echo"	<td valign='middle' align='left'>".$fila[0]."</td>";
										  echo"	<td valign='middle' align='left'>".$fila[1]."</td>";
										  echo"	<td valign='middle' align='left'>".$fila[2]." ".$fila[3]."</td>";
										  ...
										  echo"	<td valign='middle' align='center'>".str_replace("*",".",str_replace(".",",",str_replace(",","*",number_format($fila[6],2))))."</td>";	
										  echo"</tr>";
								  }
								  else
								  {
								  		  ...
								  		  echo"<tr>";
										  echo"	<td valign='middle' align='center' colspan=6>------------------------------------------------------------------------------</td>";
										  echo"</tr>";
										  echo"<tr>";
										  echo"	<td valign='middle' align='left'>".$fila[0]."</td>";
										  echo"	<td valign='middle' align='left'>".$fila[1]."</td>";
						...
						echo"<tr  valign='middle'>";
						echo"<td bgcolor='#F1F1F1' class='titulo' align='right' colspan=5><b>Total:</b></td>";
