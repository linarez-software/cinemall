...
<form method="post" name="form1" action="" >
			...
			while ($fila=mysql_fetch_array($result)){
				if($fila["CODIGO_CAJA"]!=$caja && $caja!=""){
							echo"<tr bgcolor='#F1F1F1' height='35'>";
						  echo"	<td valign='middle' align='right' colspan=3 class='contenido3'><b>TOTAL CAJA $caja:</b></td>";
						  echo"	<td valign='middle'  bgcolor='#c1c1Fc' align='center' class='contenido3'><b>".str_replace("*",".",str_replace(".",",",str_replace(",","*",number_format($tteCAJA,2))))."</b></td>";	
						  echo"	<td valign='middle'  bgcolor='#c1c1Fc' align='center' class='contenido3'><b>".str_replace("*",".",str_replace(".",",",str_replace(",","*",number_format($ttcCAJA,2))))."</b></td>";	
						  echo"	<td valign='middle'  bgcolor='#c1c1Fc' align='center' class='contenido3'><b>".str_replace("*",".",str_replace(".",",",str_replace(",","*",number_format($tttCAJA,2))))."</b></td>";	
						  echo"	<td valign='middle'  bgcolor='#c1c1Fc' align='center' class='contenido3'><b>".str_replace("*",".",str_replace(".",",",str_replace(",","*",number_format($ttdCAJA,2))))."</b></td>";	
						  echo"	<td valign='middle'  bgcolor='#c1c1Fc' align='center' class='contenido3'><b>".str_replace("*",".",str_replace(".",",",str_replace(",","*",number_format($ttd2CAJA,2))))."</b></td>";	
						  echo"	<td valign='middle' align='center' class='contenido3'><b>".str_replace("*",".",str_replace(".",",",str_replace(",","*",number_format($tteCAJA+$ttcCAJA+$tttCAJA+$ttd2CAJA+$ttigftCAJA,2))))."</b></td>";	
						  echo"</tr>";
						  $tteCAJA=0;	
							$ttdCAJA=0;	
							$ttd2CAJA=0;	
					  ...
					  if ($fila["CODIGO_CAJA"]==99)
					  {
						  ...
						  echo"	<td valign='middle' align='center' class='contenido3'><b>".str_replace("*",".",str_replace(".",",",str_replace(",","*",number_format($fila[3]+$ttigft,2))))."</b></td>";	
						  echo"</tr>";
						  $tte=0;	
						  $ttd=0;	
						  $ttd2=0;	
						 ...
						 $igft=0;
						  ...
						  $tttigftCAJA=$tttigftCAJA+$ttigft;
