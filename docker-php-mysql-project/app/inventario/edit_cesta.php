...
function Validar(id)
{
 ...
 document.form1.action="edit_cesta.php?insert=0&id=" +id;
...
if ($_GET["insert"]==0)
{
	...
	$sql="update pv_tbc_cesta_ticket set ";
		$sql.="DESCRIPCION_CESTA_TICKET ='".strtoupper($_POST[producto])."' ";
		$sql.=" where CODIGO_CESTA_TICKET =$_GET[id] ";
...
{
	$query="SELECT *
             FROM pv_tbc_cesta_ticket 
             WHERE CODIGO_CESTA_TICKET=$_GET[id]";
...
<table width="95%" border="0" align="center">
  <tr>
	...
	<?php
		$lb_title="Editar Cestas Tickets";
