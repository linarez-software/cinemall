...
<table width="175" height="100%" cellpadding="1" cellspacing="1" border="0">
    ...
    <td height="18"><a href="botones2.php" class="css-elemento-menu">Botones Vip</a></td></tr>
    <td height="18"><a href="fecha.php" class="css-elemento-menu">Fecha Vip</a></td></tr>
    <td height="18"><a href="configuracion.php" class="css-elemento-menu">Tasa</a></td></tr>
    <?php
        }
