...
function valida(tipo1)
{
	if(document.form1.tipo.value==1) {
		document.form1.action="reporte_ventas2.php?tipo1=" + tipo1;
	}
	if(document.form1.tipo.value==2) 
    {
    document.form1.action="reporte_ventas.php?tipo1=" + tipo1;
    }
  if(document.form1.tipo.value==3) 
    {
    document.form1.action="reporte_ventas3.php?tipo1=" + tipo1;
    }
			...
			?>
                <table width="400" border="1" align="center">
                  ...
                  <tr>
                    ...
                    <?php if($_SESSION['NIVEL']==1) {?><button type="submit" id="cal-button-1" style="calendar">...</button><?php }?>
                  ...
                  <tr><td align="left" class="titulo" >
                   Hasta:&nbsp;</td><td>&nbsp;
                    ...
                    <?php if($_SESSION['NIVEL']==1) {?><button type="submit" id="cal-button-2" style="calendar">...</button><?php }?>
                    <script type="text/javascript">
                        Calendar.setup({
                  ...
                  <tr height="35">
                    ...
                    <select name="tipo" class="input">
                        ...
                        <option value="2">-----------PRODUCTOS----------</option><option value="3">-----------PRODUCTOS  SIN PRECIO----------</option>
                    </select>
                    </td>
