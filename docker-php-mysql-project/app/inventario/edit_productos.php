...
function Validar(id)
{
   if ((document.form1.producto.value=="")||(document.form1.precioVIP.value=="")||(document.form1.dolar.value=="") ||(document.form1.precioVIP.value=="") ||(document.form1.marca.value=="") ||(document.form1.unidad.value=="") ||(document.form1.cant.value=="") ||(document.form1.precio.value=="") ||(document.form1.codigo.value==""))
   {
        ...
        <table width="100%" align="center" border="0">
          ...
          <tr height="30">
            ...
            <tr height="30">
              ...
              <td>
                <input type="text" class="input" name="display" id="display" size="50" maxlength="6" value="<?php echo $display;?>"  onKeyPress="return(SoloNumero(event))" >					</td>
            </tr>
            <tr height="30">
            ...
            <tr height="30">
              ...
              <td>
                <input type="text" class="input" name="dolarvip" id="dolarvip" size="50" maxlength="10" value="<?php echo $dolarvip;?>"  onKeyPress="return(SoloNumeroDec(event))" >          </td>
            </tr>
            <tr height="30">
                <td width="249" class="etiqueta"><b>*</b>Precio:</td>
              <td>
            ...
            <tr height="30">
                <td width="249" class="etiqueta"><b>*</b>Precio VIP:</td>
              <td>
                <input type="text" readonly='readonly' class="input" name="precioVIP" id="precioVIP" size="50" maxlength="10" value="<?php echo $preciovip;?>"  onKeyPress="return(SoloNumeroDec(event))" >					</td>
            </tr>
            <tr height="30">
			...
			<tr height="30">
              ...
              <td>
                <input type="text" class="input" name="costo" id="descuento" size="50" maxlength="12" value="<?php echo $costo;?>"  onKeyPress="return(SoloNumeroDec(event))" >					</td>
            </tr>
            <tr height="30">
            ...
            <tr height="30">
              ...
              <td>
               ...
               <?php
				...
				$selected1=($muestra==0) ? "selected='selected'" : "";
              			$selected2=($muestra==1) ? "selected='selected'" : "";
              		echo"<option value='0' $selected1>NO</option>";
				echo"<option value='1' $selected2>SI</option>";
				echo "</select>";
				?> 
