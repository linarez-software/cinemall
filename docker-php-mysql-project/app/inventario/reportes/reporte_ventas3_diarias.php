			...
			while ($fila=mysql_fetch_array($result)){
					  if ($fila["CODIGO_CAJA"]==99)
					  {
						 ...
						 $igft=0;
						  ...
						  echo"	<td valign='middle' align='right' class='contenido2' >".str_replace("*",".",str_replace(".",",",str_replace(",","*",number_format($fila[3]+$igft,2))))."</td>";	
						  $t+=($fila[3]+$igft);	
						  $tte+=$te;	
						  $ttt+=$tt;	
						  $ttc+=$tc;	
