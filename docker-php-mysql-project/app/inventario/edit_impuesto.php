...
function Validar(id)
{
 ...
 document.form1.action="edit_impuesto.php?insert=0&id=" +id;
...
if ($_GET["insert"]==0)
{
	...
	$sql="update pv_tbc_impuestos set ";
		$sql.="DESCRIPCION_IMPUESTO ='$_POST[producto]' ";
		$sql.=",PORCENTAJE_IMPUESTO ='$_POST[producto2]' ";
		$sql.=" where CODIGO_IMPUESTO =$_GET[id] ";
    $result = mysql_query($sql);
	mysql_close ($enlace);
	echo"<script>window.opener.location.href='impuesto.php';</script>";	
	echo"<script>window.close();</script>";
}
else
{
	$query="SELECT *
             FROM pv_tbc_impuestos 
             WHERE CODIGO_IMPUESTO=$_GET[id]";
  ...
  <tr>
	...
	<?php
        ...
        <table width="100%" align="center" border="0">
          ...
          <tr height="30">
                <td width="200" class="etiqueta">  Porcentaje:</td>
                <td width="911">
              <input  type="text" class="input" name="producto2" id="producto2" size="50" maxlength="100" value="<?php echo $producto2;?>" onKeyPress="return(SoloNumeroDec(event))" ></td>
          </tr>
