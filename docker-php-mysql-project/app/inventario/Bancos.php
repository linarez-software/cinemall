...
{
	window.open ("edit_bancos.php?insert=1&id="+   codigo ,"Help","scrollBars=yes,resizable=no,toolbar=no,menubar=yes,top =10,left=10,location=no,directories=no,width=600,height=300"); 
}
function valida()
{
	   window.open ("add_bancos.php?insert=1", "Help","scrollBars=yes,resizable=no,toolbar=no,menubar=no,top =10,left=10,location=no,directories=no,width=600,height=300");  
...
<tr>
	...
	<form method="post" name="form1" action="Consulta_facturas.php" >
            ...
            <?php
			  ...
			  echo"<tr>";
			  echo"	<td bgcolor='#F1F1F1' class='titulo' colspan='3' align='center'>Listado de Bancos</td>";
			  echo"</tr>";
			 echo"<tr>";
			  ...
			  echo"</tr>";	  
			  $query="select * from pv_tbc_bancos ";
