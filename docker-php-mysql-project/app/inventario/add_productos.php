...
function Validar()
{
   if ((document.form1.producto.value=="") ||(document.form1.precioVIP.value=="")||(document.form1.dolar.value=="")||(document.form1.dolarvip.value=="") ||(document.form1.marca.value=="") ||(document.form1.unidad.value=="") ||(document.form1.cant.value=="") ||(document.form1.precio.value=="") ||(document.form1.codigo.value==""))
   {
...
if ($_GET["insert"]==0)
{
	$sql="insert into pv_tbc_productos values(NULL,'".strtoupper($_POST[producto])."','$_POST[marca]','$_POST[unidadagrupada]','$_POST[cant]','$_POST[precio]','$_POST[impuesto]','$_POST[codigo]','$_POST[categoria]','".$_POST[unidad]."','$_POST[costo]','$_POST[descuento]','$_SESSION[login_usu]',now(),'$_POST[display]','$_POST[imprimible]','$_POST[imprimiblevip]','$_POST[precioVIP]','$_POST[listado]','','$_POST[muestra]','$_POST[dolar]','$_POST[dolarvip]')"; 
...
<table width="100%" border="0" align="center">
  ...
  <tr height="30">
            ...
            <tr height="30">
              ...
              <td>
                <input type="text" class="input" name="dolarvip" id="dolarvip" size="50" maxlength="10" value="0"  onKeyPress="return(SoloNumeroDec(event))" >          </td>
            </tr>
            <tr height="30">
                <td width="249" class="etiqueta"><b>*</b>Precio:</td>
              <td>
                <input readonly='readonly' type="text" class="input" name="precio" id="precio" size="50" maxlength="10" value="0"  onKeyPress="return(SoloNumeroDec(event))" >					</td>
            </tr>
            <tr height="30">
                <td width="249" class="etiqueta"><b>*</b>Precio VIP:</td>
              <td>
                <input readonly='readonly' type="text" class="input" name="precioVIP" id="precioVIP" size="50" maxlength="10" value="0"  onKeyPress="return(SoloNumeroDec(event))" >					</td>
            </tr>
            ...
            <tr height="30">
              ...
              <td>
                <input type="text" class="input" name="costo" id="costo" size="50" maxlength="12" value="<?php echo $costo;?>"  onKeyPress="return(SoloNumeroDec(event))" >					</td>
            </tr>
            <tr height="30">
        ...
        <tr height="30">
            ...
            <tr height="30">
             ...
             <tr height="30">
                <td width="249" class="etiqueta"><b>*</b> Muestra Precio:</td>
              <td>
               <?php
              echo "<select  name='muestra' class='input' >;";
              echo"<option value='0'>NO</option>";
              echo"<option value='1'>SI</option>";
              echo "</select>";
              ?> 
