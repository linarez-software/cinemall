...
$qry .= "AND t.usuario_registro= '$usuario' ";
if($sala > 0):
...
<html>
<head>
<title>Ventas Sala Taquilla</title>
...
<table width="90%" align="center" cellpadding="0" cellspacing="0">
	<tr>
		<td colspan="2" align="center" class="titulo-reporte" valign="middle" height="40">VENTAS DIA TAQUILLA</td>
	</tr>
	<tr>
		<td align="left" width="50%" class="cine-nombre"><b>Cine:</b><?=$cine;?></td>
		<td align="right" width="50%" class="fecha"><b>Fecha:</b> <?=$dia;?> <?=$fecha_impresion;?></td>
	</tr>
	<tr>
	...
	if($result):
			...
			if($pelicula_actual != $campo->pelicula):
				...
				if($subtotal_boletos > 0):
					...
					if($total_pelicula_monto > 0):
						$table .= "<tr> \n";
						$table .= "<td align='right' colspan='5' class='total-pelicula'>Total Pel&iacute;cula: </td> \n";
				...
				$table .= "<tr> \n";
				$table .= "<td align='left' height='31' colspan='6' class='pelicula-nombre'><b>Pel&iacute;cula:</b> $pelicula_actual</td> \n";
				$table .= "</tr> \n";
			endif;
		...
		$table .= "<tr> \n";
		$table .= "<td align='right'colspan='5' class='total-pelicula'>Total Cine: </td> \n";
