...
function ImprimirBoleto(){
	window.open("ticket.php", "Boletos","width=10,height=10,top=20,left=40,scrollbars=YES,titlebar=NO,resizable=YES,toolbar=NO,menubar=NO,directories=NO,location=NO,status=NO");
}
...
<tr>
	<td align="left" width="100%" height="100%" valign="top"><table width="100%" height="100%" cellpadding="0" cellspacing="0">
		...
		<tr>
			...
			$javascript = "";
			if($boletos > 0):
				$javascript = ' onClick="ImprimirBoleto()"';
			endif;
			?>
			<td width="150" valign="middle" align="center"><a href="javascript:void(0)" <?=$javascript;?>><img src="images/img-boton-imprimir.png" border="0" alt="Imprimir Boletos" onMouseDown="this.src='images/img-boton-imprimir-press.png'" onMouseUp="this.src='images/img-boton-imprimir.png'" onMouseOut="this.src='images/img-boton-imprimir.png'"></a></td>
		</tr>
	</table></td>
</tr>
</table>
