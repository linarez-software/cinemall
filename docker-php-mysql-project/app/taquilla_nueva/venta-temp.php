...
$qry .= "id_precio, costo, recargo, total_transaccion, usuario_registro, status, porcentaje_distribuidor, numerada) Values (";
$qry .= "'$session', $funcion, '$fecha', 1, $boletos, $precio, $costo, 0, ";
$qry .= $boletos * $costo;
