...
function marcar(valor){	
	...
	if(boletos.length < 3){
		document.frmboletos.boletos.value = document.frmboletos.boletos.value + valor;
	}
...
<table align="center" width="280" cellpadding="0" cellspacing="5">
	<tr>
		<td align="center"><input height="29" align="middle" type="hidden" id="boletos" name="boletos" readonly="true" class="boletos-campo"></td>
	</tr>
	<tr>
		<td align="center">
