...
<body margin=0 style="background-image: url('fondo2.jpg');background-repeat: no-repeat;   background-position: center;background-size: 	105% ; ">
<table width="100%" cellpadding="0" cellspacing="0" border="0" >
<tr>
	<td width="40" valign="middle" align="center" class="censura" height="150"></td>
