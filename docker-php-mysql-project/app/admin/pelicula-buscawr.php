...
$qry = "SELECT p.id_pelicula, nombre_espanol, nombre_corto, nombre_ingles, id_distribuidor, duracion, 
		id_censura, pagina_web, id_genero, sinopsis, activo, MAX(porcentaje) as porcentaje 
...
<tr>
	<td colspan="7" height="35" width="100%"><table width="100%" cellpadding="0" cellspacing="0" border="0">
		<tr>
...
while($campo = mysql_fetch_object($result)){
	...
	$table .= "<td align='center'><a href='".$modulo."foto&idp=$campo->id_pelicula' class='css-datos-consulta'><img src='images/camara.png' width='20' ></a></td>"."\n";
