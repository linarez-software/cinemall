...
?>
<tr>
	<td width="100%" class="css-titulo-metadata" height="18">&nbsp;&nbsp;Vespertina</td>
</tr>
<form name="vespertina" method="get" action="vespertina.php">
<tr>
	<td>
		<table width="100%" cellpadding="1" cellspacing="1" bgcolor="#FFFFFF">
			<tr bgcolor="#DDDDDD">
				<td width="19%" class="css-label-metadata">Fecha:</td>
				<td width="81%"><input name="fecha" type="text" class="css-campo-metadata-id" size="30" value="<?php echo $fecha;?>" readonly></td>
			</tr>
			<tr bgcolor="#DDDDDD">
				...
				<input name="idc" type="hidden" value="<?php echo $id_cine;?>"></td>
			</tr>
			<tr bgcolor="#DDDDDD">
				<td width="19%" class="css-label-metadata">Sala:</td>
				<td width="81%"><input name="sala" type="text" class="css-campo-metadata-id" size="10"  value="<?php echo buscar_sala($id_sala);?>" readonly>
				<input name="ids" type="hidden" value="<?php echo $id_sala;?>"></td>
			</tr>
			<tr bgcolor="#DDDDDD">
			...
			<tr bgcolor="#DDDDDD">
				...
				<td width="81%"><?php echo combo_hora3((isset($hora_i) ? $hora_i : -1), 'hora_i');?>&nbsp;<?php echo combo_minuto((isset($minu_i) ? $minu_i : -1),'minu_i');?></td>
			</tr>
			<!--
			<tr bgcolor="#DDDDDD">
