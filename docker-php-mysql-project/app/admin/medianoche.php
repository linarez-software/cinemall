	...
	<td>
		<table width="100%" cellpadding="1" cellspacing="1" bgcolor="#FFFFFF">
			...
			<tr bgcolor="#DDDDDD">
				...
				<td width="81%"><?php echo combo_hora6((isset($hora_i) ? $hora_i : -1), 'hora_i');?>&nbsp;<?php echo combo_minuto((isset($minu_i) ? $minu_i : -1),'minu_i');?></td>
			</tr>
			<!--
			<tr bgcolor="#DDDDDD">
				<td width="19%" class="css-label-metadata">Hora Final:</td>
				<td width="81%">?php echo combo_hora6((isset($hora_f) ? $hora_f : -1), 'hora_f');?>&nbsp;?php echo combo_minuto((isset($minu_f) ? $minu_f : -1),'minu_f');?></td>
			</tr>
			-->
		</table>
	</td>
