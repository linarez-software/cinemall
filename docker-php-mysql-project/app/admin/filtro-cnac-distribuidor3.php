...
$modulo = REPORTES."resumen-cnac-distribuidor3";
...
if (document.filtro.formato.value==2)document.filtro.action="reportes/resumen-cnac-distribuidor3.php";
}
</script>
<table width="100%" cellpadding="0" cellspacing="0">
<tr>
	<td width="100%" class="css-titulo-metadata" height="18">&nbsp;&nbsp;CNAC 4</td>
</tr>
	...
	<td>
		<table width="100%" cellpadding="1" cellspacing="1" bgcolor="#FFFFFF">
			...
			<tr bgcolor="#DDDDDD">
				<td width="19%" class="css-label-metadata">Distribuidor:</td>
				<td width="81%">
				<select name="formato" class="css-campo-metadata">
