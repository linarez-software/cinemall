...
$modulo = REPORTES."ventas_salas_taquilla";
...
var campo1 = formulario.usuario_registro.value;
...
<tr>
	<td width="100%" class="css-titulo-metadata" height="18">&nbsp;&nbsp;Ventas Usuarios </td>
</tr>
<form name="filtro" method="POST" action="<?php echo $modulo;?>2" onSubmit="return validar(this)">
<tr>
	<td>
