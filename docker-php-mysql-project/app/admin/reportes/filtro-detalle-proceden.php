...
$modulo = REPORTES."detalle-proceden";
...
function validar(formulario){
	...
	var campo1 = formulario.procedencia.value;
...
<tr>
	<td width="100%" class="css-titulo-metadata" height="18">&nbsp;&nbsp;Peliculas por Procedencia</td>
</tr>
	...
	<td>
		<table width="100%" cellpadding="1" cellspacing="1" bgcolor="#FFFFFF">
			<tr bgcolor="#DDDDDD">
				...
				<td width="81%"><?php echo combo_cine(1, 5);?></td>
			</tr>
            ...
            <tr bgcolor="#DDDDDD">
				...
				<td width="81%">
                <?php echo combo_procedencia ((!empty($id_procedencia) ? $id_procedencia : 0)); ?>
                </td>
			</tr>
		</table>
	</td>
