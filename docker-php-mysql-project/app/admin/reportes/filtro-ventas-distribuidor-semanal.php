...
$modulo = REPORTES."ventas-distribuidor-semanal";
...
<tr>
	<td width="100%" class="css-titulo-metadata" height="18">&nbsp;&nbsp;Resumen Pel&iacute;cula Distribuidor</td>
</tr>
	...
	<td>
		<table width="100%" cellpadding="1" cellspacing="1" bgcolor="#FFFFFF">
			...
			<tr bgcolor="#DDDDDD">
				...
				<td width="81%"><?php echo combo_sala(1, (isset($sala) ? $sala : 0));?></td>
			</tr>
		</table>
	</td>
</tr>
