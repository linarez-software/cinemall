...
<tr>
	<td width="100%" class="css-titulo-metadata" height="18">&nbsp;&nbsp;Ventas Mensual </td>
</tr>
		...
		<table width="100%" cellpadding="1" cellspacing="1" bgcolor="#FFFFFF">
			...
			<tr bgcolor="#DDDDDD">
				...
				<td width="81%" valign="middle" height="26"><table width="100%" cellpadding="0" cellspacing="0"><tr>
					<td valign="middle" width="80"><input name="fecha1" type="text" class="css-campo-metadata" id="fecha1" value="<?php echo isset($fecha_programacion) ? $fecha_programacion : $fecha_actual;?>" size="12" readonly>                    </td>
                  ...
                  <td align="left" class="css-info-metadata">&nbsp;&nbsp;Fecha Hasta: &nbsp;<input name="fecha2" type="text" class="css-campo-metadata" id="fecha2" value="<?php echo isset($fecha_programacion) ? $fecha_programacion : $fecha_actual;?>" size="12" readonly>&nbsp;&nbsp;
					<a href="javascript:showCal('fecha2');"><img src="images/img-calendario.gif" border="0" onMouseOut="this.src='images/img-calendario.gif'" onMouseOver="this.src='images/img-calendario-on.gif'"></a>					</td>
				</tr></table>				</td>
			</tr>
            
            <tr bgcolor="#DDDDDD">
				<td width="19%" class="css-label-metadata">Mostrar Boletos:</td>
				<td width="81%"><input name="boleto" id="boleto" type="checkbox" class="ccs-campo-metadata"></td>
			</tr>
		</table>
	</td>
</tr>
