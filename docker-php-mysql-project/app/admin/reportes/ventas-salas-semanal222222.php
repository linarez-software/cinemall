		...
		while($campo=mysql_fetch_object($result)):
			...
			if($pelicula_actual != $campo->pelicula):
				...
				if($cccc > 0):
					...
					$table .= "<td width='20%' align='right' class='pelicula-total'><b>".number_format($cccc, 0, ',', '.')."</b></td> \n";
					$table .= "<td align='left' colspan='2' ><img src='images/tr.gif'></td> \n";
					$table .= "<td width='20%' align='right' class='pelicula-total'><b>".number_format($subtotal_monto, 2, ',', '.')."</b></td> \n";
					$table .= "</tr> \n";	
