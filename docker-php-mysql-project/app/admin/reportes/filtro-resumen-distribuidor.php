...
$modulo = REPORTES."resumen-distribuidor";
...
//	var campo1 = formulario.distribuidor.value;
...
<tr>
	<td width="100%" class="css-titulo-metadata" height="18">&nbsp;&nbsp;Resumen Distribuidor</td>
</tr>
	...
	<td>
		<table width="100%" cellpadding="1" cellspacing="1" bgcolor="#FFFFFF">
			...
			<tr bgcolor="#DDDDDD">
				...
				<td width="81%" valign="middle" height="26"><table width="100%" cellpadding="0" cellspacing="0"><tr>
					<td valign="middle" width="80">
                    	<input name="fecha1" type="text" class="css-campo-metadata" id="fecha1" value="<?php echo isset($fecha_programacion) ? $fecha_programacion : $fecha_actual;?>" size="12" readonly>
                    </td>
                  ...
                  <td align="left" class="css-info-metadata">&nbsp;&nbsp;Fecha Hasta:&nbsp;
                     <input name="fecha2" type="text" class="css-campo-metadata" id="fecha2" value="<?php echo isset($fecha_programacion) ? $fecha_programacion : $fecha_actual;?>" size="12" readonly>&nbsp;&nbsp;
			...
			<tr bgcolor="#DDDDDD">
				...
				<td width="81%"><?php echo combo_funcion_distribuidor();?></td>
			</tr>
		</table>
	</td>
</tr>
