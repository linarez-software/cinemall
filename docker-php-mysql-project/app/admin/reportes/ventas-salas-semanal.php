...
$get = "modulo=ventas-salas-semanal&fecha1=".$_REQUEST['fecha1']."&sala=$sala&cine=$cine&pelicula=$pelicula&salida=imp";
//phpinfo();
...
$qry .= "WHERE DATE(t.fecha_operacion) between '$fecha_desde' and '$fecha_hasta'";
...
<table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
	...
	if(mysql_num_rows($result) > 0):
		...
		$table .= "<tr> \n";
		$table .= "<td align='center' height='21' colspan='6' class='pelicula-nombre'>Semana del ".formato_fecha($fecha_desde,2)." al ".formato_fecha($fecha_hasta,2)."</td> \n";
		$table .= "</tr> \n";
		...
		$table .= "<tr> \n";
		$table .= "<td align='right'colspan='5' class='total-pelicula'>Total Sala $sala_actual: </td> \n";
