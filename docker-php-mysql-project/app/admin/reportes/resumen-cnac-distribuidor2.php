...
$qry .= "WHERE id_distribuidor like '$distribuidor' and fecha_programacion >= '$fecha_desde' AND fecha_programacion <= '$fecha_hasta' ";
if($pelicula > 0):
...
<table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
	...
	if(mysql_num_rows($result) > 0):
		...
		while($campo=mysql_fetch_object($result)):
			...
			if($cine_actual <> $campo->cine):
				...
				$table .= "<td align='center' height='21' class='encabezado-reporte' >Boleto Iva Alícuota (%)</td> \n";
				$table .= "<td align='center' height='21' class='encabezado-reporte' >Boleto ISEP Alícuota (%)</td> \n";
				$table .= "<td align='center' height='21' class='encabezado-reporte' >Precio Servicio</td> \n";
				$table .= "<td align='center' height='21' class='encabezado-reporte' >Servicio Iva Alícuota (%)</td> \n";
				$table .= "<td align='center' height='21' class='encabezado-reporte' >Servicio ISEP Alícuota (%)</td> \n";
				$table .= "<td align='center' height='21' class='encabezado-reporte' >Otros Cargos </td> \n";
				$table .= "<td align='center' height='21' class='encabezado-reporte' >Otros Cargo Iva Alícuota (%)</td> \n";
				$table .= "<td align='center' height='21' class='encabezado-reporte' >Otros Cargo ISEP Alícuota (%)</td> \n";
				$table .= "<td align='center' height='21' class='encabezado-reporte' >Total Precio Boleto</td> \n";
				$table .= "<td align='center' height='21' class='encabezado-reporte' >N° de Espectadores</td> \n";
				$table .= "<td align='center' height='21' class='encabezado-reporte' >Total Recaudación Bs.</td> \n";
			...
			$qry = "SELECT	pr.comentario as boleto, 
							...
							sum(total_transaccion) as recaudacion,municipal,iva ";
			...
			if(mysql_num_rows($r_operacion) > 0):
				while($campo2=mysql_fetch_object($r_operacion)):
					...
					$table .= "<td align='center' height='21' class='reporte'>".number_format(($campo2->precio*100/($campo2->iva+100+$campo2->municipal)), 2, ',', '')."</td> \n";
					...
					$base=($campo2->recaudacion*100)/(100+$campo2->municipal+$campo2->iva);
					$table .= "<td align='right' height='21' class='reporte'>".number_format(0, 2, ',', '')."</td> \n";
					//$table .= "<td align='right' height='21' class='reporte'>".number_format(($campo2->recaudacion*$campo2->iva)/($campo2->iva+100+$campo2->municipal), 2, ',', '')."</td> \n";
					//$table .= "<td align='right' height='21' class='reporte'>".number_format(($campo2->recaudacion*$campo2->municipal)/($campo2->iva+100+$campo2->municipal), 2, ',', '')."</td> \n";
					$table .= "<td align='right' height='21' class='reporte'>".number_format(0, 2, ',', '')."</td> \n";
					$table .= "<td align='right' height='21' class='reporte'>".number_format(0, 2, ',', '')."</td> \n";
					$table .= "<td align='right' height='21' class='reporte'>".number_format(0, 2, ',', '')."</td> \n";
					$table .= "<td align='right' height='21' class='reporte'>".number_format(0, 2, ',', '')."</td> \n";
					...
					$t1=$t1+(($campo2->precio*100/($campo2->iva+100+$campo2->municipal)));
					$t2=$t2+($campo2->precio*$campo2->espectador);
					$t3=$t3+($campo2->espectador);
	...
	$table .= "<tr> \n";
	$table .= "<td align='right' height='21' class='encabezado-reporte' colspan='19'></td> \n";
	$table .= "<td align='right' height='21' class='encabezado-reporte' >".number_format($t3,0)."</td> \n";
