...
$get = "modulo=ventas-servicio&fecha1=".$_REQUEST['fecha1']."&sala=$sala&cine=$cine&pelicula=$pelicula&salida=";
//phpinfo();
...
<table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
	...
	<?php endif;?>
	<tr>
		<td align="left" colspan="2" width="90%" class="titulo-reporte" valign="middle" height="30">Ventas Diarias Servicios</td>
	</tr>
	<tr>
	...
	if(mysql_num_rows($result) > 0):
		...
		while($campo=mysql_fetch_object($result)):
			...
			$table .= "<td width='15%' align='right' class='info'>".number_format($campo->comision, 2, ',', '.')."</td> \n";
			$monto = ($campo->boletos * $campo->comision);
