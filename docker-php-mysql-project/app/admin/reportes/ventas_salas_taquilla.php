...
$qry = "SELECT t.usuario_registro, tp.id_sala, tper.nombre AS precio, t.costo, t.comision, SUM( t.cantidad_transaccion ) AS boletos, SUM( t.total_transaccion ) AS monto, ";
...
$qry .= "ORDER BY t.usuario_registro, tp.id_sala, tpe.nombre_espanol, tp.hora_inicio, ts.nombre, tper.costo ";
//echo $qry;
...
<table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
	...
	if(mysql_num_rows($result) > 0):
		...
		while($campo=mysql_fetch_object($result)):
			/* ENCABEZADO USUARIO */
			if($usuario_actual != $campo->usuario_registro):
				$usuario_actual = $campo->usuario_registro;
				$table .= "<tr> \n";
				$table .= "<td align='left' height='21' colspan='6' class='pelicula-nombre'><b>Usuario:</b> $usuario_actual</td> \n";
				$table .= "</tr> \n";
			endif;
			...
			$table .= "<td width='15%' align='right' class='info'>".number_format($campo->costo+$campo->comision, 2, ',', '.')."</td> \n";
		...
		$table .= "<td width='10%' align='right' class='cine-total'>".number_format($total_cine_boletos, 0, ',', '.')."</td> \n";
		$table .= "<td width='20%' align='right' class='cine-total'></td> \n";
		$table .= "<td width='20%' align='right' class='cine-total'></td> \n";
