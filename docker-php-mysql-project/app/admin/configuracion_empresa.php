	...
	<td>
		<table width="100%" cellpadding="1" cellspacing="1" bgcolor="#FFFFFF">
			...
			<tr bgcolor="#DDDDDD">
				...
				<td width="81%"><input name="fomprocine" type="text" class="css-campo-metadata" size="5" maxlength="5" value="<?php echo isset($fomprocine) ? $fomprocine : 0;?>">
			...
			<tr bgcolor="#DDDDDD">
				<td  width="19%" class="css-label-metadata">IVA:</td>
				<td width="81%"><input name="isv" type="text" class="css-campo-metadata" size="5" maxlength="2" value="<?php echo isset($isv) ? $isv : 12;?>">
				<span class="css-info-metadata">&nbsp;&nbsp;</span></td>
			</tr>
			<tr bgcolor="#DDDDDD">
				<td  width="19%" class="css-label-metadata">Tasa:</td>
				<td width="81%"><input name="tasa" type="text" class="css-campo-metadata" size="10" maxlength="10" value="<?php echo isset($tasa) ? $tasa : 1;?>">
				<span class="css-info-metadata">&nbsp;&nbsp;</span></td>
			</tr>
			<!--<tr bgcolor="#DDDDDD">
