...
while($campo = mysql_fetch_object($result)){
	...
	$table .= "<a href='".$modulo."&idg=$campo->id_genero'>"."\n";
	$table .= "<tr bgcolor=$bgcolor ".rowSelect($bgcolor,'out')." ". rowSelect($bgcolor_select,'over') ." >"."\n";
	$table .= "<td align='center'><a href='".$modulo."&idg=$campo->id_genero' class='css-datos-consulta'>$campo->id_genero</a></td>"."\n";
	$table .= "<td align='center'><a href='".$modulo."&idg=$campo->id_genero' class='css-datos-consulta'>$campo->nombre</a></td>"."\n";
	$x_activo = $campo->activo == 0 ? 'No Activo' : 'Activo';
	$table .= "<td align='center'><a href='".$modulo."&idg=$campo->id_genero' class='css-datos-consulta'>$x_activo</a></td>"."\n";
