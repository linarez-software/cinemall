        ...
        <table width="100%" align="center" border="0">
          ...
          <tr height="30">
            ...
            <tr height="30">
              ...
              <td>
                <input type="text" class="input" name="precio" id="precio" size="50" maxlength="6" value="<?php echo $PRECIO;?>"  onKeyPress="return(SoloNumeroDec(event))" >					</td>
            </tr>
            <tr height="30">
                <td width="249" class="etiqueta"><b>*</b>Precio VIP:</td>
              <td>
                <input type="text" class="input" name="precioVIP" id="precioVIP" size="50" maxlength="6" value="<?php echo $preciovip;?>"  onKeyPress="return(SoloNumeroDec(event))" >					</td>
            </tr>
            <tr height="30">
