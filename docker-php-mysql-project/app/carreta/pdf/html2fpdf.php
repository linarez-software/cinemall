...
function TextWithRotation($x, $y, $txt, $txt_angle, $font_angle=0)
    {
        ...
        $s=sprintf('BT %.2F %.2F %.2F %.2F %.2F %.2F Tm (%s) Tj ET',$txt_dx,$txt_dy,$font_dx,$font_dy,$x,($this->h-$y)*$this->k,$this->_escape($txt));
        if ($this->ColorFlag)
...
//! @return An object (a class instance)
  ...
  $this->DisplayPreferences('');
	...
	$this->lineheight = 3.5; // Related to FontSizePt == 11
