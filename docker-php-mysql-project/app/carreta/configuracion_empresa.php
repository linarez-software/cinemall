...
$qry = "SELECT id_configuracion, nombre_empresa, server_ip, logo_empresa, limite_funcion, rif, nit, direccion, telefono, municipal, fomprocine, alquiler,tasa FROM tbl_configuracion ";
