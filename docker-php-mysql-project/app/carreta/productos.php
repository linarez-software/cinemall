...
{
		document.form1.action="productos.php?act=1"; document.form1.submit();  
...
<tr>
	...
	<form method="post" name="form1" action="productos.php" >
            ...
            <?php
			  ...
			  if (isset( $_GET['act'])){
			  	if (( $_GET['act']==1)){
					 ...
					 $qry = "UPDATE pv_tbc_productos SET 
							...
							precio = (preciodolar*$tasa) where preciodolar>0
							 "; 
			  ...
			  echo"<tr>";
			  echo"	<td bgcolor='#F1F1F1' class='titulo' colspan='10' align='center' onclick='vista2();'>Imprimir Listado de productos</td>";
			  echo"</tr>";
			  ...
			  if($_SESSION['NIVEL']==1){
					  echo"<tr>";
					  echo"	<td bgcolor='#F1F1F1' class='css-elemento-menu' colspan='10' align='center'><a href='#' onClick='valida();' class='css-elemento-menu'>AGREGAR</a></td>";
					  echo"</tr>";
					  echo"<tr>";
					  echo"	<td bgcolor='#F1F1F1' class='css-elemento-menu' colspan='9' align='center'><b>Tasa:</b><input name='tasa' type='text' class='css-campo-metadata' size='10'  onKeyPress='return(SoloNumeroDec(event))'  maxlength='10' value='".(isset($tasa) ? $tasa : 1)."'>
<br><a href='#' onClick='valida22();' class='css-elemento-menu'><b>Actualizar Precios</b></a></td>";
			  ...
			  echo"<tr height='45'>";
			  echo"	<td bgcolor='#F1F1F1' class='titulo' colspan='10' align='center'>Filtrar : <input class='input'  name='txt' value='$txt' type='text' size='50' maxlength='10'>&nbsp;&nbsp;<br><input type='submit' value='BUSCAR' class='input' onclick='Validart();'></td>";
			  echo"</tr>";
			  ...
			  while ($fila=$rs->obtenerArray()){
				  ...
				  echo"	<td class='titulo' align='center'>".number_format($fila["preciodolar"],2)."</td>";
