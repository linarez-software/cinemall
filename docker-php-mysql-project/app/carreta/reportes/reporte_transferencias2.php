...
<form method="post" name="form1" action="Consulta_facturas.php" >
			...
			$result = mysql_query("SELECT *
							FROM
							pv_tbc_almacenes
							where CODIGO_ALMACEN like'$_GET[almacen2]'
							");
					while ($rs=mysql_fetch_array($result)){
							$dep2=$rs[1];
					}
			if ($_GET[almacen2]=='%') $dep2="TODOS";
			$sql = " SELECT
					...
					WHERE
					pv_tbc_encabezado_movimientos.STATUS_MOVIMIENTO <> 'ANULADA' and ALMACEN_ORIGEN like '$_GET[almacen]' and ALMACEN_DESTINO like '$_GET[almacen2]'  and tipo_movimiento='TRA'
			...
			echo"<td  valign='middle' bgcolor='#F1F1F1' class='titulo' align='center' colspan='5'><b>Tranferencias</b></td>";
			echo"</tr>";
			echo"<tr  valign='middle' height=30>";
			echo"<td  valign='middle' bgcolor='#F1F1F1' class='titulo' align='center' colspan='5'><b>Listado de Tranferencias<br>Desde:&nbsp;".$fec[2]."/".$fec[1]."/".$fec[0]."&nbsp;&nbsp;&nbsp;Hasta:&nbsp;".$fec2[2]."/".$fec2[1]."/".$fec2[0]." </b></td>";
			echo"</tr>";
			echo"<tr  valign='middle' height=30>";
			echo"<td  valign='middle' bgcolor='#F1F1F1' class='titulo' align='center' colspan='5'><b>Almacen Origen: $dep</b></td>";
			echo"</tr>";
			echo"<tr  valign='middle' height=30>";
			echo"<td  valign='middle' bgcolor='#F1F1F1' class='titulo' align='center' colspan='5'><b>Almacen Destino: $dep2</b></td>";
			echo"</tr>";
