...
function valida(tipo1)
{
	if(document.form1.tipo.value==1) {
		document.form1.action="reporte_entradas2.php?tipo1=" + tipo1;
	}
	else
		{
		document.form1.action="reporte_entradas.php?tipo1=" + tipo1;
		}
...
<tr>
	...
	<form method="post" name="form1" action="Consulta_facturas.php" >
			<table width="400" border="0" align="center">
              <tr><td>
			<?php
			$lb_title="Entradas de  Mercancias";
			include "main/open_table.php";
			?>
                <table width="400" border="1" align="center">
                  <tr>
                    <td class="TITULO" colspan="2" align="center">Entradas</td>
                  </tr>
                  <tr height="25">
