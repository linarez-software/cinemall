...
function EliminarProgramacion(reg){
	alert(reg);
	xEliminar=confirm("Desea Eliminar esta programación de la base de datos");
	
	if(xEliminar){
	 alert(xEliminar);
	  var myAjax = new Ajax.Request('include/func.ajax.php', 
			{
			  method: 'get', 
			  parameters: 'fn=3&reg='+reg, 
...
function Validar(){
	...
	if(libre > 0){
		alert("La película seleccionada ya esta programada en este horario.");
		return false;	
	}
	...
	<td>
		<table width="100%" cellpadding="1" cellspacing="1" bgcolor="#FFFFFF">
			<tr bgcolor="#DDDDDD">
				...
				<td width="81%"><input name="fecha" id="fecha" type="text" class="css-campo-metadata-id" size="30" value="<?=$fecha;?>" readonly></td>
			</tr>
			<tr bgcolor="#DDDDDD">
				...
				<input name="idc" id="idc" type="hidden" value="<?=$id_cine;?>"></td>
			</tr>
			<tr bgcolor="#DDDDDD">
				<td width="19%" class="css-label-metadata">Sala:</td>
				<td width="81%"><input name="sala" id="sala" type="text" class="css-campo-metadata-id" size="10"  value="<?=buscar_sala($id_sala);?>" readonly>
				<input name="ids" id="ids" type="hidden" value="<?=$id_sala;?>"></td>
			</tr>
			...
			?>
	            <tr bgcolor="#DDDDDD">
					<td width="19%" class="css-label-metadata">Días Repetir:</td>
