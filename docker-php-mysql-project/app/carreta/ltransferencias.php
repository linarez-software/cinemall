...
{
//	document.form1.action="reporte_transferencias2.php?tipo1=" + tipo1;
  ...
  if(document.form1.tipo.value==1) {
    ...
    {
    document.form1.action="reporte_transferencias.php?tipo1=" + tipo1;
    }
...
<tr>
	...
	<form method="post" name="form1" action="Consulta_facturas.php" >
			<table width="400" border="0" align="center">
              <tr><td>
			<?php
			$lb_title="Tranferencias entre almacenes";
			include "main/open_table.php";
			?>
                <table width="400" border="1" align="center">
                  <tr>
                    <td class="TITULO" colspan="2" align="center">Transferencias</td>
                  </tr>
                  <tr height="25">
                    <td class="TITULO" width="147">Almacen Origen:</td>
                  ...
                  <tr height="25">
                    <td class="TITULO" width="147">Almacen Destino:</td>
                    <td align="left">&nbsp;
                    <?php
                    echo "<select  name='almacen2' class='input'>;";
                    $result = mysql_query("SELECT
                            *
                            FROM
                            pv_tbc_almacenes order by 1
