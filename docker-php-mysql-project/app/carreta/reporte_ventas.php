...
<form method="post" name="form1" action="" >
			...
			$sql = " SELECT
					tbl_usuario.username,tbl_usuario.nombre_completo,pv_tbc_encabezado_movimientos.CODIGO_USUARIO
					from
					...
					tbl_usuario.nombre_completo,pv_tbc_encabezado_movimientos.CODIGO_USUARIO
					order by username
			...
			echo"<td  valign='middle' bgcolor='#F1F1F1' class='titulo' align='center' colspan='6'><b>Ventas</b></td>";
			echo"</tr>";
			echo"<tr  valign='middle' height=30>";
			echo"<td  valign='middle' bgcolor='#F1F1F1' class='titulo' align='center' colspan='6'><b>Ventas por productos<br>Desde:&nbsp;".$fec[2]."/".$fec[1]."/".$fec[0]."&nbsp;&nbsp;&nbsp;Hasta:&nbsp;".$fec2[2]."/".$fec2[1]."/".$fec2[0]." </b></td>";
			echo"</tr>";
			echo"<tr  valign='middle' height=30>";
			...
			while ($fila1=mysql_fetch_array($result1)){
				$sql = " SELECT
					...
					SUM(pv_tbl_detalle_movimientos.CANTIDAD_UNITARIA*pv_tbl_detalle_movimientos.PRECIO_UNITARIO) MON,tbl_usuario.username,tbl_usuario.nombre_completo
					from
					pv_tbc_encabezado_movimientos
					...
					WHERE
					pv_tbc_encabezado_movimientos.STATUS_MOVIMIENTO <> 'ANULADA' and ALMACEN_ORIGEN like '$_POST[almacen]'  and tipo_movimiento='FAC'
					and FECHA_EMISION >='$_POST[desde]' and FECHA_EMISION<='$_POST[hasta]' and pv_tbc_encabezado_movimientos.CODIGO_USUARIO=$fila1[2]
					GROUP BY 
					pv_tbc_productos.CODIGO_PRODUCTO,
					pv_tbc_productos.DESCRIPCION_PRODUCTO,
					pv_tbl_detalle_movimientos.PRECIO_UNITARIO,
					...
					order by username,pv_tbc_productos.CODIGO_PRODUCTO
					...
					"		;	
						...
						while ($fila=mysql_fetch_array($result)){
								  echo"<tr>";
								  echo"	<td valign='middle' align='left'>".$fila[6]."-".$fila[7]."</td>";
