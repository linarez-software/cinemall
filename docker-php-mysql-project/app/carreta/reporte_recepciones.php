...
function imprimir()
{
	window.open ("reportes/reporte_recepciones.php?desde=" + document.form1.desde.value + "&hasta=" + document.form1.hasta.value + "&origen=" + document.form1.origen.value + "&almacen=" + document.form1.almacen.value ,"Help","scrollBars=yes,resizable=no,toolbar=no,menubar=yes,top =10,left=10,location=no,directories=no,width=10,height=10"); 
...
<form method="post" name="form1" action="reportes/reporte_recepciones2.php" >
			...
			while ($fila=mysql_fetch_array($result)){
					  ...
					  echo"	<td valign='middle' align='center'>".str_replace("*",".",str_replace(".",",",str_replace(",","*",number_format($fila[6]*$fila[4],2))))."</td>";	
					  $t+=$fila[5];	
					  $t1+=($fila[6]*$fila[4]);	
