...
$sql="SELECT
		...
		";
	$sql.=" where TIPO_MOVIMIENTO='ENT' and  ID_MOVIMIENTO=".$_GET["id"];
...
while ($rs=mysql_fetch_array($result)){
	...
	$htm=$htm."    </tr> ";
	$htm=$htm."              <tr>";
	$htm=$htm."                <td colspan='4' align='center'  bgcolor='#F1F1F1' ><div align='center'><B>NOTA DE ENTRADA</B></div></td>";
	$htm=$htm."              </tr>";
	$htm=$htm."             <tr>";
	...
	$htm=$htm."<tr>";
	$htm=$htm."	<td bgcolor='#F1F1F1'  colspan='5' align='center'>Detalle de Entrada</td>";
	$htm=$htm."</tr>";
	...
	$htm2=$htm2."</tr>";
	$htm2=$htm2."<tr>";
	$htm2=$htm2."	<td bgcolor='#F1F1F1'  colspan='5' align='center'>Detalle Nota de Entrada</td>";
	$htm2=$htm2."</tr>";
	...
	$pdf -> Output("ENTRADA".$codigo.".pdf", "D");
?>