...
function valida(tipo1)
{
	if(document.form1.tipo.value==1){
		document.form1.action="reporte_ventas22_diarias.php?tipo1=" + tipo1;
	}
	else
	{
		document.form1.action="reporte_ventas222_diarias.php?tipo1=" + tipo1;	
	}
	...
	<form method="post" name="form1" action="Consulta_facturas.php" >
			...
			?>
                <table width="400" border="1" align="center">
                  <tr>
                    <td class="TITULO" colspan="2" align="center">Facturas Anuladas</td>
                  </tr>
                  <tr>
                  ...
                  <tr><td align="left" class="titulo" >
                   Tipo:&nbsp;</td><td>&nbsp;
                    <select name="tipo">
                    	...
                    	<option value="1">PRODUCTO DEVUELTOS</option>
                    </select>
                    </td>
