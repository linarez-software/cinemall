...
if($status > 0):
	...
	if($campo_prog = mysql_fetch_object($result_prog)):
		...
		if($id_programacion > 0):
			...
			$qry .= "costo, recargo, total_transaccion, usuario_registro, status, transmitido, hora_operacion, porcentaje_distribuidor) VALUES (";
			$qry .= "$cine, $id_programacion, '$fecha', 2, $cantidad, $precio, $costo, 0, $total_transaccion, ". $_SESSION['USER'] .", 1, 0, '". date("H:i:s")."', $porcentaje)";
			echo $qry;
	...
	<td>
		<table width="100%" cellpadding="1" cellspacing="1" bgcolor="#FFFFFF">
			...
			<tr bgcolor="#DDDDDD">
				...
				<input name="cine" type="hidden" value="<?=$cine;?>"></td>
			</tr>
			<tr bgcolor="#DDDDDD">
