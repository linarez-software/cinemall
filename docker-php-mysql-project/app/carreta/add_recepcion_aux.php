				...
				echo"<table width='100%' border='1' cellspacing='0' cellpadding='0'>";
					...
					$descv=0;
					 while ($rs=mysql_fetch_array($result)){
						...
						echo"	<td class='TITULO2' align='center'>".number_format(($rs[9]-(($rs[7]*1.12)-($rs[7]*1.12*($rs[8]/100))))/$rs[9],2)."</td>";
					...
					echo"	<td class='TITULO2' align='right' colspan=2>".number_format($subv*100/112,2)."</td>";
					...
					echo"</tr>";
					echo"<tr>";
					echo"	<td class='TITULO' align='right' colspan=8>Iva 12 %:</td>";
					echo"	<td class='TITULO2' align='right' colspan=2>".number_format(($sub-$desc)*0.12,2)."</td>";
					echo"	<td class='TITULO2' align='right' colspan=2>".number_format($subv*12/112,2)."</td>";
					echo"	<td class='TITULO2' align='right' colspan=2></td>";
					echo"	<td class='TITULO' align='right' > </td>";
					echo"</tr>";
					echo"<tr>";
					echo"	<td class='TITULO' align='right' colspan=8>Total:</td>";
					echo"	<td class='TITULO2' align='right' colspan=2>".number_format(($sub-$desc)*1.12,2)."</td>";
