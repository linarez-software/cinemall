...
function imprimir()
{
	window.open ("reportes/reporte_ventas22_diarias.php?desde=" + document.form1.desde.value + "&hasta=" + document.form1.hasta.value ,"Help","scrollBars=yes,resizable=no,toolbar=no,menubar=yes,top =10,left=10,location=no,directories=no,width=10,height=10"); 
...
<form method="post" name="form1" action="" >
			...
			$sql = " select * from pv_factura_eliminar
						WHERE
											 FECHA >='$_POST[desde]' and FECHA<='$_POST[hasta]'
			";
