...
function guardar()
{
	document.form1.action="botones2.php?i=1";
...
<tr>
	...
	<form method="post" name="form1" action="botones2.php" >
            ...
            <?php
			  ...
			  if(isset($_GET["i"]))
			  {
			  	...
			  	$sql="update pv_tbc_botones_vip set
					bot1=$_POST[bt1],
					bot2=$_POST[bt2],
					bot3=$_POST[bt3],
					bot4=$_POST[bt4],
			  ...
			  echo"</tr>";	  
			  $query="select * from pv_tbc_botones_vip ";
