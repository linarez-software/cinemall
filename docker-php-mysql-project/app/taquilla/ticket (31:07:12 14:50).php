...
$qry .= "p.nombre, p.comentario, butacas, numerada, p.contenido ";
...
while($campo_venta = mysql_fetch_object($temp_venta)):
	...
	if($incompletas==0):
		...
		$qry_insert .= "costo, comision, total_transaccion, usuario_registro, status, porcentaje_distribuidor, hora_operacion) VALUES ( ";
		...
		$qry_insert .= "$campo_venta->costo, $campo_venta->comision, $campo_venta->total_transaccion, $campo_venta->usuario_registro, 1, $campo_venta->porcentaje_distribuidor, '$hora_operacion') ";
		//echo $qry_insert;
		...
		if($campo_datos = mysql_fetch_object($result_datos)):
			...
			$logo_encabezado = "";
			if($numerada==1):
				$logo_encabezado = "<img src='images/logo-cinemall-taquilla.gif' border='0' align='left'>";
			endif;
			?>
			<table width="250" border="0" cellpadding="0" cellspacing="0">
			    ...
			    <tr>
					<td width="250" align="center">
			            ...
			            <span class="empresa1">Rif. <?=$empresa_rif;?></span></p>			
			        </td>
			    </tr>
			    <tr>
					<td width="250"><table width="100%" cellpadding="0" cellspacing="0" class="sala"><tr>
			            <td align="right">Fecha: <span class="fecha"><?php echo ucfirst(strftime("%A", strtotime($campo_datos->fecha)))." ".date("d/m/Y",strtotime($campo_datos->fecha));?></span></td>
			    ...
			    <tr>
			        ...
			        <td height="19">
						...
						$class_precio = "precio";
						$p = "";
						if($campo_venta->id_precio==47 || $campo_venta->id_precio==25 || $campo_venta->id_precio==49 || $campo_venta->id_precio==50 || $campo_venta->id_precio==70):
							$class_precio = "precio-nino";
							$p = "N";
						endif;
						?>
		            	<span class="<?php echo $class_precio;?>"><b><?=$campo_venta->precio;?></b>  Bsf. <?php echo $campo_venta->costo+$campo_venta->comision;?></span>&nbsp;<br>
		            ...
		            <td width="160" valign="middle" align="right" >
		                <span class="sala2"><?php echo $p.$prefijo;?><?php echo $campo_datos->sala;?><?php echo $butaca;?></span>
		            </td>
			        </tr></table></td>
			    </tr>
			    <?php
				...
				?>
				<tr>
			    	<td height="60" width="250" valign="middle" align="center" style="border-top: 1px dashed #000;">
						<span style="font-size: 14px; font-family: Verdana;"><i><?php echo $campo_venta->contenido;?></i></span>
					</td>
			    </tr>
			    <?php
				endif;
			    ...
			    <tr>
					<td width="250">
			            <span class="precio"><?=$campo_venta->comentario;?>  Bsf. <?php echo $campo_venta->costo + $campo_venta->comision;?></span><br>
			            <!--<span class="impuesto">Imp. Espec. Pub. Incluido</span><br>-->
						<span class="impuesto">EXCENTO DE IVA</span><br>
