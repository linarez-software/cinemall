...
$qry .= "p.nombre, p.comentario, butacas, numerada, p.contenido, p.marcar, p.marca,p.foncine,p.dosporuno  ";
...
while($campo_venta = mysql_fetch_object($temp_venta)):
	...
	if($incompletas==0):
		...
		$qry_insert .= "costo, comision, total_transaccion, usuario_registro, status, porcentaje_distribuidor, hora_operacion,municipal,iva,foncine,transmitido,tarjeta,efectivo,dolar,tasa) VALUES ( ";
		...
		$qry_insert .= "$campo_venta->costo, $campo_venta->comision, $campo_venta->total_transaccion, $campo_venta->usuario_registro, 1, $campo_venta->porcentaje_distribuidor, '$hora_operacion','$municipal','$isv','$foncine',$trasmitido,'".($montotarjeta)."','$montoefectivo','".($dolar)."','$tasa') ";
		//echo $qry_insert;
		$montotarjeta=0;
		$trasmitido=0;
		$montoefectivo=0;
		...
		$nombre_pelicula = "";
		if($campo_id2 = mysql_fetch_object($result_id2)):
			$nombre_pelicula = $campo_id2->nombre_espanol;
		endif;
		...
		if($campo_datos = mysql_fetch_object($result_datos)):
			...
			for($dosporuno=1;$dosporuno<=$campo_venta->dosporuno;$dosporuno++){?>
			<table width="250" border="0" cellpadding="0" cellspacing="0">
			    ...
			    <tr>
			        ...
			        <td height="19">
						...
						if($dosporuno==1){
						?>
		            	<span class="pelicula"><b><?php echo $campo_venta->precio;?></b>  Bsf. <?php echo $campo_venta->costo+$campo_venta->comision;?></span>&nbsp;<br>
		            	<?php
		            	}
		            	else{
		            		?>
		            		<span class="pelicula"><b>CORTESIA</span>&nbsp;<br>
		            	<?php
		            	}
		            	?>
			   ...
			   <tr>
					<td width="250">
			            ...
			            <?php
		            		...
		            		?>
		            		<span class="<?php echo $class_precio;?>"><b>CORTESIA</span>&nbsp;<br>
		            	<?php
		            	}
		            	?>
			            <!--<span class="impuesto">Imp. Espec. Pub. Incluido</span><br>-->
			    ...
			    <tr>
			         <td width="250" class="pelicula" height="15" align="left" valign="middle">
						<b>Entrada <?php echo $dosporuno." de ".$campo_venta->dosporuno;?></b>
			        </td>
			    </tr>
			    <tr>
