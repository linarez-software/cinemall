...
if($status > 0){ 
	...
	$Query1 = "SELECT username, nombre_completo FROM tbl_usuario WHERE username = '$username' AND passwd = '$passwd' and activo=1 AND (nivel=4 or nivel=1 or nivel=3 or nivel=2) "; 
